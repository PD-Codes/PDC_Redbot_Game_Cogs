    ...
    async def search_for_string(self, api_client, embeds, search_string):
        async with api_client:
            ...
            search_methods = [  # Currently only 1 method, but this is for future expansion
                [
                    api_client.Classic.GameData.get_spell_search,
                    api_client.Classic.GameData.get_spell_media,
                    api_client.Classic.GameData.get_spell,
                    "spell",
                ],
                [
                    api_client.Classic.GameData.get_item_search,
                    api_client.Classic.GameData.get_item_media,
                    api_client.Classic.GameData.get_item,
                    "item",
                ],
            ]
